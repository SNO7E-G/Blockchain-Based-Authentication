...
const Profile = () => {
  const { user, walletInfo, logout } = useAuth();
  ...
  // Handle message signing for verification
  const handleSignMessage = async () => {
    ...
    try {
      const message = `Verify ownership of wallet: ${walletInfo.address} at ${new Date().toISOString()}`;
      const result = await signMessage(walletInfo.signer, message);
                  ...
                  {signatureResult && (
                    <div className="mt-4">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="mt-1 bg-gray-100 p-2 rounded break-all">
                          <code className="text-xs">{signatureResult.message}</code>
                        </div>
                      </div>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="mt-1 bg-gray-100 p-2 rounded break-all">
                          <code className="text-xs">{signatureResult.signature}</code>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
                  <div className="space-y-6">
                    ...
                    <div className="pt-6 border-t border-gray-200">
                      <h4 className="text-sm font-medium text-gray-900">Account Recovery</h4>
                      <p className="mt-1 text-sm text-gray-500">
                        Set up recovery options for your account in case you lose access to your wallet.
                      </p>
                      <div className="mt-2">
                        <button
                          type="button"
